...
> **更新**：2026-07-11（**开发期**；**v2.2.0** 向量叶 multi_output_tree 训练；v2.1.6 lint 门禁 + race/panic 修复；v2.1.5 MovieLens 四段流水线）  
...
| 线 | 方案状态 | 代码/发布 | 结论 |
|----|----------|-----------|------|
| **Agentic** | Phase 0–5 + POST 加固 | tag **v2.1.0** … **v2.2.0** | **完成** |
...
**最新 tag**：https://github.com/linkerlin/leaves/releases/tag/v2.2.0
