...
Convenience: leaves.NewLearnerFromModelAndData.
CLI/Agent: cmd/leaves (skills/leaves-autotrain).

Legacy (compat, not preferred for new code): LGEnsembleFromFile / XGEnsembleFromFile.
